...
class _HomePageState extends State<HomePage>
  ...
  Widget catNew(){
    return Padding(
      ...
      child: catList  ==  null || catList == " " ? Text("isLodding..."):GridView.count(
  ...
  Widget productList1(){
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: sectionList == null || sectionList == "" ? Text("Lodding....") : ListView.builder(
        // shrinkWrap: true,
          physics: ScrollPhysics(),
          scrollDirection: Axis.horizontal,
                  ...
                  Expanded(
                    child: Container(
                      ...
                      Text("${sectionList[0].productList![index].name}"),
                       Text("${sectionList[0].productList![index].prVarientList![0].disPrice!}"),
